...
const help =
  __("this will be used in many places, including login and loading screens. An image with transparent background and a resolution of 160 x 32 is preferred");
