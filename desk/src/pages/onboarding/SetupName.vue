...
const text =
  __("Now, let's set a name for your Helpdesk that reflects your organization's identity and values. So, what would you like to name your Helpdesk?");
const subText =
  __("Choose a name that resonates with your brand and instills trust in your customers");
