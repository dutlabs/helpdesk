<template>
  ...
  >
    ...
    >
      <div
        class="bg-surface-white flex min-w-[596px] items-center space-x-3 rounded-lg px-4 py-2 shadow-2xl"
        :class="$attrs.class"
      >
        <slot
          v-bind="{
        ...
        >
          <div
            class="border-outline-gray-2 text-ink-gray-9 flex flex-1 justify-between border-r"
          >
